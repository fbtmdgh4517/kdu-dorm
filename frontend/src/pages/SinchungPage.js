                ...
                <form>
                    ...
                    <div className="max-w-md container mx-auto mb-4">
                        ...
                        <input
                            name="date"
                            id="date"
                            className="border border-black max-w-md container mx-auto rounded-xl shadow-md h-10 transition ease-in-out hover:scale-105 px-2 text-gray-400"
                            type="datetime-local"
                        />
                        ~
                        <input
                    ...
                    <div className="max-w-md container mx-auto mb-4">
                        ...
                        <textarea
                            name="reason"
                            id="reason"
                            className="border border-black max-w-md container mx-auto rounded-xl shadow-md h-20 transition ease-in-out hover:scale-105 px-2 overflow-auto"
                        />
                    </div>
